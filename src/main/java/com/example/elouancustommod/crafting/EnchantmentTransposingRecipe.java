...
public class EnchantmentTransposingRecipe extends CustomRecipe {
  public static final SimpleCraftingRecipeSerializer<EnchantmentTransposingRecipe> SERIALIZER =
  ...
  @Override
  public @NotNull ItemStack assemble(CraftingInput inv, HolderLookup.@NotNull Provider access) {
    ...
    if (transposer != null
        ...
        && this.canDisenchant(transposer, stackList.getFirst()))
      return this.disenchant(transposer, stackList.getFirst()).getA();
